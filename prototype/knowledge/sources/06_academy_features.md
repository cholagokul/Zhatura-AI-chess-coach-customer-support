...
How academy admin and coach roles are separated, and what permissions each role has, is not yet documented in verified sources.

## Reporting and onboarding
What academy reports, onboarding flows, branding options or billing arrangements exist is not yet documented in verified sources.

## Scale and limits
How many students an academy can manage, and any other academy-specific capabilities or limits, are not yet documented in verified Zhatura sources. Never invent scale numbers or limits; say the verified academy details are not available yet.
